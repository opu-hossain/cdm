/* Vendored from Nuklear v4.13.3 (a53ad2c658151071501372a5e0e5e978153835aa).
 * The vendored Nuklear pair carries a cursor patch in nuklear.h;
 * this SDL adapter is otherwise unchanged from upstream.
 */
/*
